...
function help() {
    ...
    echo -e "  ${AMBER}ethereum${NC}   - Set up Telescope for the Ethereum network."
    echo -e "  ${AMBER}polkadot${NC}   - Set up Telescope for the Polkadot network."
    echo -e "  ${AMBER}arbitrum${NC}   - Set up Telescope for the Arbitrum network."
    echo -e "  ${AMBER}base${NC}       - Set up Telescope for the Base network."
    echo -e "  ${AMBER}optimism${NC}   - Set up Telescope for the Optimism network."
    echo -e "\n${BWHITE}Example:${NC}"
